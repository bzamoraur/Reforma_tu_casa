...
- 🔒 Levels 2–5 are present as locked stubs (content pending expert validation).
- ✅ Content schema + safety linter, unit + golden tests (79 passing), production build, GitHub Actions CI, clean `npm audit`.
